...
class SSM_Team_Metaboxes {
	...
	/**
	 * Register the metaboxes to be used for the SSM Team
	 *
	 * @since 0.1.0
	 */
		...
		<table class="form-table">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_title"><?php _e( 'Title', 'ssm-team' ); ?>
					</label>
				</td>
				<td colspan="4">
					<input type="text" name="profile_title" class="regular-text" value="<?php echo $title; ?>">
					<p class="description"><?php _e( 'E.g. CEO, Sales Lead, Designer', 'ssm-team' ); ?></p>
				</td>
			</tr>

			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_linkedin"><?php _e( 'LinkedIn URL', 'ssm-team' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_twitter"><?php _e( 'Twitter URL', 'ssm-team' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_facebook"><?php _e( 'Facebook URL', 'ssm-team' ); ?>
					</label>
				</td>
				<td colspan="4">
